...
import static fr.vinetos.tranquille.data.DenylistUtils.patternToHumanReadable;
...
public class DenylistItemRecyclerViewAdapter extends GenericRecyclerViewAdapter
        <DenylistItem, DenylistItemRecyclerViewAdapter.ViewHolder> {

    private SelectionTracker<Long> selectionTracker;

    public DenylistItemRecyclerViewAdapter(
        ...
        return new ItemDetailsLookup<Long>() {
            ...
            public ItemDetails<Long> getItemDetails(@NonNull MotionEvent e) {
                ...
                if (view != null) {
                    ...
                    if (holder instanceof DenylistItemRecyclerViewAdapter.ViewHolder) {
                        return ((DenylistItemRecyclerViewAdapter.ViewHolder) holder).getItemDetails();
                    }
                }
                return null;
            }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.denylist_item, parent, false);
        return new DenylistItemRecyclerViewAdapter.ViewHolder(view);
    }

    class ViewHolder extends GenericRecyclerViewAdapter
            <DenylistItem, DenylistItemRecyclerViewAdapter.ViewHolder>.GenericViewHolder {
        ...
        void bind(DenylistItem item) {
            ...
            pattern.setText(patternToHumanReadable(item.getPattern()));
            ...
            if (item.getNumberOfCalls() > 0) {
                ...
                String dateString = lastCallDate != null
                        ...
                        : context.getString(R.string.denylist_item_date_no_info);

                stats.setText(context.getResources().getQuantityString(
                        R.plurals.denylist_item_stats, Math.toIntExact(item.getNumberOfCalls()),
    ...
    static class DiffUtilCallback extends DiffUtil.ItemCallback<DenylistItem> {
        ...
        public boolean areItemsTheSame(@NonNull DenylistItem oldItem,
            ...
            if (oldItem.getId() != -1L || newItem.getId() != -1L) {
